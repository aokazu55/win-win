...
RSpec.describe 'プロフィール機能', type: :model do
  ...
  describe 'バリデーションテスト' do
    ...
    it '「address_id」が空ならバリデーションは通らない' do
      blank_address_id = Profile.(nickname: 'ニック', date_of_birth: '1981-3-9', gender_id: '1', address_id: '', personality_id: '1', special_skill_id: '1', introduce: 'test1')
    ...
    it '「全て」が入力されていればバリデーションは通る' do
      full_profile = Profile.new(nickname: 'ニック', date_of_birth: '1981-3-9', gender_id: '1', address_id: '1', personality_id: '1', special_skill_id: '1', introduce: 'test1')
