...
RSpec.describe 'プロフィール機能', type: :model do
  ...
  describe 'バリデーションテスト' do
    it '「nickname」が空ならバリデーションは通らない' do
      blank_nickname = Profile.new(nickname: 'テスト', date_of_birth: '1981-3-9', gender_id: '1', address_id.name: '北海道', personality_id.name: '真面目', special_skill_id.name: '家事', introduce: 'test1')
