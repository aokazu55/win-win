...
RSpec.describe 'プロフィール機能', type: :model do
  ...
  describe 'バリデーションテスト' do
    ...
    it '「全て」が入力されていればバリデーションは通る' do
      full_profile = Profile.newProfile.create(nickname: 'ネーム', date_of_birth: '1981年3月10日', gender_id: '女性', address_id: '東京都', personality_id: 'さわやか', special_skill_id: '料理', introduce: 'test2')
