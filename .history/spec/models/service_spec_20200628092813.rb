...
RSpec.describe 'サービス機能', type: :model do
  ...
  describe 'バリデーションテスト' do
    it '「main_service_id」が空ならバリデーションは通らない' do
      blank_main_servicd_id = Service.new(main_service_id: '', service_detail_id: 'あいさつ', service_name: 'おはよう', confidence_level_id: '世界で5本の指に入る', price: '100', working_time: '2', remark: 'test11', transportation_expenses: '無料', user_id: '1')
