class User < ActiveRecord::Base
  ...
  has_many :passive_favorites, class_name: "Favorite",
                                  ...
                                  dependent: :destroy
  has_many :following, through: :active_favorites, source: :followed, dependent: :destroy
  has_many :followers, through: :passive_favorites, source: :follower, dependent: :destroy
