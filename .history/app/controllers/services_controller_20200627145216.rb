class ServicesController < ApplicationController
  ...
  def service_params
    params.require(:service).permit(:main_service_id, :service_detail_id, :service_name, :price, :working_time, :period_start, :period_end, :image, :confidence_level_id, :estimated_days_required, :remark, :transportation_expenses)
  end
end